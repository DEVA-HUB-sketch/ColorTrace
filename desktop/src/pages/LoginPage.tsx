      ...
      <div className="flex flex-1 items-center justify-center bg-gradient-to-br from-navy via-deepNavy to-primaryBlue p-10 text-white">
        <div className="max-w-lg">
          <div className="mb-6 flex items-center gap-4">
            <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/20 bg-white/10 text-xl font-bold text-white shadow-sm backdrop-blur-sm">
              CT
            </div>
            <div>
              <div className="text-2xl font-bold tracking-tight text-white">ColorTrace</div>
              <div className="text-sm font-medium text-blue-200">Digital Companion for Field Drug Testing</div>
            </div>
          </div>
          ...
          <div className="mt-10 flex items-center gap-3 rounded-2xl border border-white/20 bg-white/10 p-4 shadow-sm backdrop-blur-sm">
            <ShieldCheck className="h-5 w-5 text-blue-300" />
            <span className="text-sm font-medium text-white">Presumptive field-test result workflow</span>
          </div>
        </div>
      </div>

      <div className="flex flex-1 items-center justify-center bg-white p-10 dark:bg-surface">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="flex items-center justify-between rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm text-secondaryText dark:border-slate-700/80">
              <span>Access</span>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 outline-none transition focus:border-primaryBlue focus:ring-2 focus:ring-primaryBlue/20 dark:border-slate-700 dark:bg-surfaceAlt dark:text-primaryText"
            ...
            {errorMessage && (
              <div className="rounded-xl border border-rose-200 bg-rose-50 px-4 py-3 text-sm text-rose-700 dark:border-rose-900/60">
                {errorMessage}
              </div>
            )}
            ...
            <button
              ...
              className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-primaryBlue px-4 py-3 text-base font-semibold text-white shadow-soft transition hover:bg-blue-600 disabled:cursor-not-allowed disabled:opacity-60"
            >
